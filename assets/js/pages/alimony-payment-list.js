...
node.querySelector("[data-field='state']").textContent =item?.status == 1? " تم تسليم من قبل الزوج فقط" : item?.status == 2? "تم تاكيد الاستلام من المحضر ":item?.status == 3? "تم استلام من الزوجة": "غير معرفة";
